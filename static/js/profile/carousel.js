$(document).ready(function () {
  ...
  $(".center").slick({
    ...
    prevArrow:
      "<button type='button' class='slick-prev' style='color: black'>Previous</button>", // 이전 화살표 모양 설정
    nextArrow:
      "<button type='button' class='slick-next' style='color: black'>Next</button>", // 다음 화살표 모양 설정
    variableWidth: true,
  });
});
